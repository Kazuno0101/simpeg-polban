...
<div class="mb-3">
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal">
    Tambah Pengajuan Kenaikan Jabatan
  </button>
        ...
        <div class="modal-body">
            ...
            <div class="mb-3 col">
              ...
              <select class="form-select" id="dosen" aria-label="Default select example">
                ...
                @foreach ($dosen as $item)
                  <option value="{{ $item->id }}">{{ $item->nama }} - {{ $item->unitKerja->nama }} - {{ $item->jabatan->nama }}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="row g-2">
            <div class="mb-0 col">
              ...
              <select class="form-select" id="jabatan_asal" aria-label="Default select example">
            ...
            <div class="mb-0 col">
              ...
              <select class="form-select" id="jabatan_tujuan" aria-label="Default select example">
...
<div class="card">
    <h5 class="card-header">Kenaikan Jabatan</h5>
        ...
        <tbody class="table-border-bottom-0">
          @foreach ($pengajuan as $item)
            <tr>
              ...
              <td>{{ $item->jabatanAsal->nama }}</td>
              <td>{{ $item->jabatanTujuan->nama }}</td>
