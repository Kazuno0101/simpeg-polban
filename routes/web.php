...
use App\Http\Controllers\Simpeg\DosenController;
use App\Http\Controllers\Simpeg\KenaikanJafaController;
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::resource('kelola-dosen', DosenController::class)->names([
        'index' => 'dosen',
        'create' => 'dosen.create',
        'store' => 'dosen.store',
        'show' => 'dosen.show',
    ...
    Route::resource('kelola-kenaikanjafa', KenaikanJafaController::class)->names([
        'index' => 'kenaikan',
        'create' => 'kenaikan.create',
        'store' => 'kenaikan.store',
        'show' => 'kenaikan.show',
        'edit' => 'kenaikan.edit',
        'update' => 'kenaikan.update',
        'destroy' => 'kenaikan.destroy',    
    ]);    
    Route::patch('/kelola-kenaikanjafa/verifikasi/{id}', [KenaikanJafaController::class, 'verifikasi'])->name('kenaikan.verifikasi');
    Route::patch('/kelola-kenaikanjafa/persetujuan/{id}', [KenaikanJafaController::class, 'persetujuan'])->name('kenaikan.persetujuan');
